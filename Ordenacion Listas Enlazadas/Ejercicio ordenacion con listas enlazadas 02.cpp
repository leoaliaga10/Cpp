//Ejercicio metodos de ordenacion con listas enlazadas 02
/*
...
void quicksort(persona **inicio,persona **fin){
   ...
   ensambla(&startmenor,&lastmenor,&startigual,&lastigual);
   ensambla(&startmenor,&lastmenor,&startmayor,&lastmayor);
   *inicio=startmenor;
   *fin=lastmenor;
}
void guardar(){
