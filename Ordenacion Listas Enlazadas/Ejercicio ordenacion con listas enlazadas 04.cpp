//Ejercicio metodos de ordenacion con listas enlazadas 04
/*
...
[1] Quicksort Con pasos (para entender la ordenación).
*/
...
void ensambla(persona **inicio1,persona **fin1,persona **inicio2,persona **fin2){
   clrscr();
   co++;
   cout<<"Ensambla :"<<co<<endl;
   getch();
                if(*inicio1==NULL && *inicio2==NULL){
                cout<<"inicio1 y inicio2 = NULL"<<endl;getch();
                return;
   }
   if(*inicio1!=NULL && *inicio2!=NULL){
      cout<<"inicio1 y inicio2 != NULL"<<endl;
      cout<<"inicio1 : "<<(*inicio1)->nombre<<endl;
      cout<<"inicio2 : "<<(*inicio2)->nombre<<endl;
      cout<<"fin1 : "<<(*fin1)->nombre<<endl;
      cout<<"fin2 : "<<(*fin2)->nombre<<endl;
      getch();
                               (*fin1)->next=*inicio2;
      *fin1=*fin2;    //fdgdf
      cout<<"----------------"<<endl;
...
void quicksort(persona **inicio,persona **fin){
   ...
   cout<<"Actual nombre "<<actual->nombre<<endl<<endl;
   getch();
   agrega(actual,&startigual,&lastigual);
   actual=actual->next;//leop
   while(actual!=NULL){
      cout<<"Pivote  "<<pivote<<endl;
      cout<<"Actual nombre "<<actual->nombre<<endl<<endl;
                getch();
   ...
   *fin=lastmayor;
   cout<<"+++++++++++++++++"<<endl;
   cout<<"Despues de Join"<<endl;
   cout<<"inicio : "<<(*inicio)->nombre<<endl;
   cout<<"fin : "<<(*fin)->nombre<<endl;
   cout<<"+++++++++++++++++"<<endl;
   getch();
   vero(*inicio);
}
